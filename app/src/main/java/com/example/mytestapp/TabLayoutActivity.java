...
public class TabLayoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] tabs = new String[]{"关注", "推荐"};
        ...
        viewPager2.setAdapter(new FragmentStateAdapter(getSupportFragmentManager(), getLifecycle()) {
            ...
            public Fragment createFragment(int position) {
                ...
                if (position == 0) {
                    ...
                    return MineFragment.newInstance(tabs[position]);
                }
            }
        ...
        mediator = new TabLayoutMediator(tabLayout, viewPager2, new TabLayoutMediator.TabConfigurationStrategy() {
            ...
            public void onConfigureTab(@NonNull TabLayout.Tab tab, int position) {
                //这里可以自定义TabView
                TextView tabView = new TextView(TabLayoutActivity.this);
        ...
        public void onPageSelected(int position) {
            ...
            for (int i = 0; i < tabCount; i++) {
                ...
                if (tab.getPosition() == position) {
                    ...
                    tabView.setBackgroundResource(R.drawable.shape_tab_indicator_selected);
                } else {
                    tabView.setTextSize(normalSize);
                    tabView.setTypeface(Typeface.DEFAULT);
//                    tabView.setBackgroundResource(R.drawable.w);
                }
            }
        }
    };
